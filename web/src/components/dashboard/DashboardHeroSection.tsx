    ...
    <section className="overflow-hidden border border-white/10 bg-[radial-gradient(circle_at_top_left,_rgba(51,184,198,0.18),_transparent_34%),linear-gradient(180deg,_rgba(10,10,12,0.96),_rgba(4,4,5,1))]">
      <div className="grid gap-8 px-6 py-7 lg:grid-cols-[1.4fr_0.9fr] lg:px-8 lg:py-8">
        <div className="space-y-5">
          <div className="inline-flex items-center gap-2 border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.24em] text-cyan-200">
          ...
          <div className="space-y-3">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="border border-white/10 px-2.5 py-1 text-[11px] uppercase tracking-[0.22em] text-zinc-400">
                Arbitrum Sepolia
              </span>
            </div>
        ...
        <div className="border border-white/10 bg-black/30 p-5 backdrop-blur-sm">
          ...
          <div className="space-y-4 pt-4 text-sm text-zinc-300">
            <div className="flex items-start justify-between gap-4 border-b border-white/5 pb-3">
              <div>
                <p className="text-[11px] uppercase tracking-[0.22em] text-zinc-500">EntryPoint</p>
                <p className="mt-1 font-medium text-white">0x5FF1...2789</p>
              </div>
              <span className="border border-emerald-500/20 bg-emerald-500/10 px-2 py-1 text-[10px] uppercase tracking-[0.2em] text-emerald-300">
                Connected
              </span>
            </div>
            ...
            <div className="flex items-start justify-between gap-4 border-b border-white/5 pb-3">
              ...
              <span className="border border-cyan-500/20 bg-cyan-500/10 px-2 py-1 text-[10px] uppercase tracking-[0.2em] text-cyan-200">
                Live
              </span>
            </div>
