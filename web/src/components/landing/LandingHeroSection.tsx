...
export default function LandingHeroSection({
  ...
  return (
    <section className="mx-auto flex min-h-[calc(100vh-92px)] w-full max-w-7xl flex-col items-center justify-center px-6 py-20 text-center sm:px-10 lg:px-12">
      <div className="max-w-5xl">
        <h1 className="mt-8 text-6xl font-semibold uppercase leading-[0.88] tracking-[-0.08em] text-white sm:text-7xl lg:text-[8.5rem]">
          The Immutable
          <br />
          Guardian for
          <br />
        ...
        <p className="mx-auto mt-8 max-w-3xl text-lg leading-8 text-zinc-300 sm:text-[22px]">
